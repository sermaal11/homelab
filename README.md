...
| Passbolt | desplegado y cargando en local | datos antiguos apartados en `_backups/passbolt-pre-fresh` | `/data/homelab/passbolt` | DB, URL local, SMTP pendiente |
...
| Passbolt | Se eligio instalacion desde cero. Los datos antiguos se apartaron en `_backups/passbolt-pre-fresh`; la URL inicial es `http://homelab:8080`, SMTP queda desactivado/pendiente y la UI carga. Pendiente crear primer usuario admin por CLI. |
